...
////////////////////////////////////////////////////////////////////////////////
// A class which has knowledge on all possible acion types.                   //
////////////////////////////////////////////////////////////////////////////////
...
public class ActionRegistry : GLib.Object {
  ...
  public static Action? create_action(string type_id, string name, string icon,
                                      string command, bool quickaction) {
    switch (type_id) {
  ...
  public static Action? new_for_uri(string uri, string? name = null) {
    ...
    switch (scheme) {
      case "application":
        ...
        var desktop_file = GLib.File.new_for_path(
          "/usr/share/applications/" + file_name
        );
  ...
  public static Action? new_for_app_info(GLib.AppInfo info) {
    ...
    return new AppAction(
      info.get_display_name(), Icon.get_icon_name(icon), info.get_commandline()
    );
  }
  ...
  private static string get_domain_name(string url) {
    ...
    if (domain_begin < domain_end) {
      return url.substring(domain_begin, domain_end-domain_begin);
    }
