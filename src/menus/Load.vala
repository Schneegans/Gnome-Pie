...
////////////////////////////////////////////////////////////////////////////////
// A helper method which loads menus according to the configuration file.     //
////////////////////////////////////////////////////////////////////////////////

namespace Pies {

  // Loads all Menus from the pies.conf file. ----------------------------------
  public void load() {
  ...
  private static void parse_group(Xml.Node* slice, Pie pie) {
    ...
    ActionGroup group = ActionGroupRegistry.create_group(type, pie.id);
